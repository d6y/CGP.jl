...
function recur_active!(active::BitArray, connections::Array{Int64}, ind::Int64)::Nothing
    if ~active[ind]
        active[ind] = true
        for i in 1:2
